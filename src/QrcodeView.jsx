                            ...
                            <div className="col-lg-12">
                              <div className="card">
                                <div className="card-header bg-primary text-white header-elements-inline">
                                  <h6 className="card-title hujjatH3" style={{ fontWeight: "bold", textTransform: "upperCase" }}>Путь документооборота</h6>
                                </div>
                                <div className="card-body hujjatCardBody">
                                  <div className="col-lg-12">
                                    ...
                                    <ul style={{ fontSize: "17px", lineHeight: "1.9", paddingLeft: "20px" }}>
                                      <li>
                                        <span className="color-black mr-1 ">Корреспондент:</span>
                              ...
                              <div className="card p-2">
                                <div className="imzo">
                                  <ul>
                                    ...
                                    <li><strong>Должность и Ф.И.О.:&nbsp;</strong> <span>{data?.document?.signedBy?.lavozim} {data?.document?.signedBy?.fullName}</span></li>
                                    <li><strong>Дата подписания:&nbsp;</strong> <span>{data?.document?.signedAt}</span></li>
                                    <li><strong>Полное имя фамилия:&nbsp;</strong> <span>{data?.document?.signedBy?.fullName}</span></li>
