...
const ChiquvchiTasdiqlanganContent=({ currentUser, permission, ranks })=> {
  ...
  return (
    <div className="content mb-5 content-mobile">
      <h3 style={{ margin: "10px 0 0 20px", fontWeight: "bold", textTransform: "upperCase" }}>Tasdiqlangan</h3>
                        ...
                        <td className="harakat">
                          <div>
                            ...
                            <div
                              ...
                              <Link
                                to={`/chiquvchi/ko'rish/tasdiqlangan/${data?.id}`}
...
export default React.memo(ChiquvchiTasdiqlanganContent);