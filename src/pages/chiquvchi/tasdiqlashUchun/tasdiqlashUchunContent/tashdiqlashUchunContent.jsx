...
const ChiquvchiTasdiqlashUchunContent=({ currentUser, permission, ranks })=> {
  ...
  return (
    <div className="content mb-5 content-mobile">
      <h3 style={{ margin: "10px 0 0 20px", fontWeight: "bold", textTransform: "upperCase" }}>Tasdiqlash uchun</h3>
              ...
              <div className="card-body card-body-mobile" style={{ padding: "30px" }}>
                ...
                <table id="myTable" className="mt-2 table table-bordered table-striped table-hover Tab">
                  ...
                  <tr className="bg-dark text-white NavLink text-center">
                    ...
                    <th id='tabRow' style={{width: '25%'}} className="qisqacha">Qisqacha mazmuni
                    </th>
                        ...
                        <td className="harakat">
                          <div>
                            ...
                            <div
                              ...
                              <Link
                                to={`/chiquvchi/ko'rish/tasdiqlash_uchun/${data?.id}`}
...
export default React.memo(ChiquvchiTasdiqlashUchunContent);