...
import './xomakiEdit.css';

const ChiquvchiXomakiEditContent = ({ currentUser, permission, ranks }) => {
            ...
            <div className="card-body card-body-mobile p-0">
                <ul className="nav nav-tabs nav-tabs-solid nav-tabs-solid-custom bg-primary NavLink"
                    ...
                    <li className="nav-item">
                        <NavLink to={`/chiquvchi/homaki/tahrirlash/${params.id}`} className="nav-link NavLinkLi"
                                    ...
                                    <div className="row">
                                        <div className="col-lg-12 px-0">
                                            <div className="row">
                                                ...
                                                {
                                                    allData[0] && <div className="col-lg-12">
                                                        <Select
                                                            options={fishka}
                                                            placeholder="Fishka"
                                                            defaultValue={{
                                ...
                                <div className="card-body card-body-mobile" style={{ padding: "10px" }}>
                                    <div className="row">
                                        <div className="col-12 border px-0 shadowBox1">
                                            ...
                                            <div
                                                className="col-lg-12 d-flex flex-lg-column align-items-center justify-content-center">
                                                <CKEditor
                                                    initData="<p>Kitob.</p>"
                                                    style={{
                                                        maxWidth: '1000px',
...
export default React.memo(ChiquvchiXomakiEditContent)