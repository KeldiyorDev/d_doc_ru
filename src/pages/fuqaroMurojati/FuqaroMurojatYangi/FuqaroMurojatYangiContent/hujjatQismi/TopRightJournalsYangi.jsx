...
export default function TopRightJournalsYangi({
                                                  setMurojaatSoni,
                                                  murojaatSoni,
                                                  objData,
                                                  currentUser,
    ...
    useEffect(() => {
        ...
        if (objData?.length > 0) {
            ...
            if (isMounted) {
                // setStartDate(new Date(objData[0]?.outDate));
    ...
    useEffect(() => {
        ...
        const getData = async () => {
            try {
                const res = await axiosInstance.get(`organization/orgCorrespondent/` + JSON.parse(localStorage.getItem('ids')));
                let arr = [];
                res?.data?.forEach((d) => {
            ...
            <div className="card">
                <div className="card-body">
                        ...
                        <div className="col-lg-12">
                            <div className="form-group row" id="men">
                                <div className="col-lg-6">
                                    {qabulTuri?.length > 0 && (
                                        <Select
                                            defaultValue={[qabulTuri?.find((d) => d?.value === objData[0]?.receptionTypeID)]}
                                            options={qabulTuri}
                                ...
                                <div className="col-lg-6">
                                    ...
                                    >
                                        Korrespondent
                                        {(dataKorrespondent.length > 0 || objData[0]?.correspondentID !== null) && (
                    ...
                    <textarea
                        ...
                        defaultValue={objData[0]?.extraAppealer}
                    />
