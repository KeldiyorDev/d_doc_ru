...
export default function TashqiBajaruvchilarFYangi({ yunalishlar, setYunalishlar, objData, results, setAlert, setResults, currentUser, allexecutorsData, openBajaruvchi }) {
