...
const FuqaroBajarilganContent = ({currentUser, permission, ranks}) => {
                            ...
                            <div className="card-body card-body-mobile">
                                ...
                                <table id="myTable" className="table table-bordered mb-3 table-striped table-hover Tab">
                                    ...
                                    {data?.content?.length > 0 && data?.content?.map((dat, index) => (
                                        <tr key={index}
                                            onClick={() => window.innerWidth <= 768 && history.push(`/fuqaro/murojati/bajarish_ijro/${dat?.id}/bajarilgan`)}>
                                  ...
                                  <span
                                      style={{fontSize: "14px"}}>{(d?.firstName && d?.firstName.length > 1) ? ((((d?.firstName[0].toUpperCase() === "S" || d?.firstName[0].toUpperCase() === "C") && d?.firstName[1].toUpperCase() === "H")) ? d?.firstName?.substring(0, 2) + ". " : d?.firstName?.substring(0, 1) + ". ") : ""} {d?.lastName}</span>
                                                ...
                                                {dat?.inExecutorViewDTOS?.find((d) => d?.directedBy) && (
                                                    <hr style={{borderTop: "1px dashed #000"}}/>
                                                )}
                                                {dat?.inExecutorViewDTOS?.length > 0 && dat?.inExecutorViewDTOS?.map((d, i) => (
                                                    d?.directedBy && (
                                                        <p key={i} style={{
                                                            margin: "0",
                                                            borderColor: "#ddd",
                                            ...
                                            <td className="harakat mobile-table-none">
                                                <div className="icon d-flex justify-content-center align-items-center ">
                                                    <Link
                                                        to={`/fuqaro/murojati/bajarish_ijro/${dat?.problemID}/bajarilgan`}
...
export default React.memo(FuqaroBajarilganContent)