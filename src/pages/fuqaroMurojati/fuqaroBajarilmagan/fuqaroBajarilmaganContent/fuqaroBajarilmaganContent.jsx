...
const FuqaroBajarilmaganContent = ({currentUser, permission, ranks}) => {
                            ...
                            <div className="card-body card-body-mobile">
                                ...
                                <table id="myTable" className="table table-bordered mb-3 table-striped table-hover Tab">
                                    ...
                                    {data?.content?.length > 0 && data?.content?.map((dat, index) => (
                                        <tr key={index}
                                            onClick={() => window.innerWidth <= 768 && history.push(`/fuqaro/murojati/bajarish_ijro/${dat?.id}/bajarilmagan`)}>
...
export default React.memo(FuqaroBajarilmaganContent)