...
export default function TopRightJournals({ setMurojaatSoni,murojaatSoni,currentUser, setDataKorrespondent, setAlert, alert, dataKorrespondent, JurnalRef, startDate, setStartDate, ReceptionTypeRef, AppealTypeRef, AppealFormRef, PageCountRef, AppealerCountRef, ExtraAppealerRef, startDateKorres, setStartDateKorres, korresRef, chiquvchiRaqamRef }) {
              ...
              <div className="form-group row">
                <div className="col-lg-12">
                  <Select
                    ...
                    className="cardTypeId  journalId "
                    isClearable={true}
                    required={true}
                    ref={JurnalRef}
                  />
              ...
              <div className="modal-dialog modal-xl pt-5 ">
                <div className="modal-content">
                  <div className="modal-header bg-primary text-white">
                    ...
                    <button className="close" onClick={() => setOpenKorres(false)} data-dismiss="modal">&times;</button>
                  </div>
                  <div className="modal-body " style={{ padding: "10px", paddingBottom: "0px" }}>
                    <div className="row">
                      ...
                      <div className="col-lg-4">
                        <div className="inputBox d-flex align-items-center justify-content-end input-border w-100 bg-white" style={{ height: '56px' }}>
                          <DatePicker
                  ...
                  <div className="modal-footer d-flex justify-content-center">
                    <button type="button" className="btn btn-danger" onClick={cancelKorres}>Bekor qilish</button>
