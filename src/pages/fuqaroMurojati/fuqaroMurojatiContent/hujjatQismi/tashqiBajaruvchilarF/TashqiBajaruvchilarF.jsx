...
export default function TashqiBajaruvchilarF({ results, setAlert, setResults, currentUser, allexecutorsData, openBajaruvchi, setYunalishlar, yunalishlar }) {
  ...
  }, [allexecutorsData, openBajaruvchi.open]);
