...
import {
    ...
    description2CitizemAppeal, description3CitizemAppeal
    ...
    useEffect(() => {
        ...
        if (objData?.length > 0) {
            ...
            objData[0]?.problems.forEach((d, indexBox) => {
                ...
                // if (allexecutorsData.find((d) => d.index === openBajaruvchi.index)) {
                // }
                        ...
                        <div className='col-lg-12 pl-2 pr-2 pt-2 pb-0'
                                        ...
                                        <div className="col-lg-3">
                                            <div className="form-group row">
                                                <div className="col-lg-12">
                                                    {tasnif1?.length > 0 && (
                                                        <Select
                                                            defaultValue={[tasnif1.find((d) => d.value === dat?.ac_1ID)]}
                                                            options={tasnif1}
                                                            placeholder="TASNIF1"
                                        ...
                                        <div className="col-lg-3">
                                            <div className="form-group row">
                                                <div className="col-lg-12">
                                                    {tasnif2?.length > 0 && (
                                                        <Select
                                                            defaultValue={tasnif2.filter((d) => d.value === dat?.ac_2ID)}
                                                            options={tasnif2}
                                        ...
                                        <div className="col-lg-3">
                                            <div className="form-group row">
                                                <div className="col-lg-12">
                                                    {tasnif3?.length > 0 && (
                                                        <Select
                                                            defaultValue={[tasnif3.find((d) => d.value === dat?.ac_3ID)]}
                                                            options={tasnif3}
                                                            placeholder="TASNIF3"
                                                            isClearable={true}
                                                            className="tasnif3"
                            ...
                            {addNewBox.map((dat, index) => (
                                <form key={index + objData[0]?.problems?.length}
                                      onSubmit={(e) => deleteFun(e, index + objData[0]?.problems?.length)}
                                      className={'addNewBoxForm col-12 mb-1 px-0'} id={dat.id}>
                                    <div className="row">
                                        <div className="col-lg-3">
                                            <div className="form-group row">
                                        ...
                                        <div className="col-lg-3">
                                            ...
                                            >
                                                Bajaruvchi
                                                {(allexecutorsData.find((d) => d.index === index + objData[0]?.problems?.length)?.ichkiBajaruvchilar?.length > 0 || allexecutorsData.find((d) => d.index === index + objData[0]?.problems?.length)?.tashqiBajaruvchilar?.length > 0) && (
                                                    <span className="bajaruvchiBadge">+</span>
                                                )}
                                            </button>
                                        </div>
                                ...
                                <div className="form-group row">
                                    <div className="col-lg-1 d-flex align-items-center">
                                        <button
                                            ...
                                            style={{
                                                backgroundColor: objData[0]?.appealStatusCode === 2 && "#0056B8",
                                                color: objData[0]?.appealStatusCode === 2 && "#fff"
                                            }}
                                        >
                                            T
                                        </button>
                                        <button
                                            ...
                                            data-bs-placement="top"
                                            style={{
                                                backgroundColor: objData[0]?.appealStatusCode === 1 && "#0056B8",
                                                color: objData[0]?.appealStatusCode === 1 && "#fff"
                                            }}
                                        >
                                            D
                                        </button>
                                        ...
                                        <div className="form-group row">
                                            <div className="col-lg-12 ">
                                                {tasdiqlovchi?.length > 0 && (
                                                    <Select
                                                        defaultValue={tasdiqlovchi.find((d) => d.value === objData[0]?.confirmerWorkPlaceID)}
