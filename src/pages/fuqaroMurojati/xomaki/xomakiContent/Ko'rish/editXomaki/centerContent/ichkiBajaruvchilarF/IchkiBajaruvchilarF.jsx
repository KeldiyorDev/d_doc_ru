...
export default function IchkiBajaruvchilarF({ objData, yangiQushish, setYangiQushish, xodimlar, setXodimlar, currentUser, allexecutorsData, openBajaruvchi }) {
    ...
    <div className="card-box ">
      <div className="col-lg-12">
        <div className="">
          ...
          {/* {objData[0]?.problems?.length > 0 && objData[0]?.problems[openBajaruvchi.index]?.inExecutors.map((dat, index) => (
            <div>
                        ...
                        <div className="d-flex col1 mb-1" style={{ flex: "1" }}>
                          <div className="checkbox chb mr-1" title="Nazorat" onClick={(e) => checkedDivNazorat(e.target, index)}>
                            ...
                            <strong className="iconCheck text-white"
                              style={{
                                display: dat?.executorStatusCode === 4 && "flex",
                                backgroundColor: dat?.executorStatusCode === 4 && "rgb(0, 86, 184)"
                              }}>N</strong>
                          </div>
