...
const XomakiContent = ({ currentUser, permission1, ranks}) => {
    ...
    const All = async () => {
        try {
            const res = await axiosInstanceFq.post(`appeal/sketchy/${JSON.parse(localStorage.getItem('oi'))}`, {
                appealTypeID: '%%',
                receptionTypeID: '%%',
                deadline: '%%',
                regNumber: '%%',
                                                ...
                                                <td className="qisqacha" style={{ width: '200px' }}>
                                                    {
                                                        dat?.problemsShortDescriptions.map((data, index1) => {
                                                            return (
                                                                <>
                                                                    <span className="mb-1 d-flex align-items-center" key={index1}>
                                                                        {/*<span style={{ fontWeight: "900" }}> {index1 + 1}.</span>*/}
                                                                        {/* <strong>Izoh:&nbsp;</strong> */}
                                                ...
                                                <td className="harakat">
                                                    <div>
                                                        <div className="icon w-100">
                                                            <Link
                                                                to={`/fuqaro/murojati/xomaki/rezolutsyaga_tayyorlash/${dat?.id}`}
                                                                className="infoBtn bg-dark" data-popup="tooltip"
                                                                title="ko'rish"><i className="icon-eye2" />
                                                            </Link>
                                                            <Link
                                                                to={`/fuqaro/murojati/xomaki/yangilash/${dat?.id}`}
                                                                title="Yangilash"
...
export default React.memo(XomakiContent);