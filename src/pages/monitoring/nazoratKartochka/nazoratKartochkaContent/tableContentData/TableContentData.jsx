      ...
      <table id="myTable" className="table-bordered table-striped table-hover Tab" >
        <thead className="theadSticky">
          <tr className="bg-dark text-white text-center tableHeader w-100">
            ...
            <th style={{ width: "5%" }}>
            Принятое решение (приказ, команда), план контроля (график, программа действий и т.п.), дата утверждения
            </th>
            <th style={{ width: "5%" }}>
            ...
            <th style={{ width: "10%" }}>
            Когда, где обсуждалась ситуация с реализацией и какие меры в отношении кого были приняты.
            </th>
          </tr>
        </thead>
